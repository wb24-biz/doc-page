...
Документаційний портал до сервісів **WB24.BIZ**, опублікований за адресою [https://doc.wb24.biz](https://doc.wb24.biz). Описує адмін-панель WaterBiz для керування мережею вендингових автоматів з продажу води.
...
src/
  ...
  css/custom.css                     # глобальні стилі (палітра WaterBiz)
